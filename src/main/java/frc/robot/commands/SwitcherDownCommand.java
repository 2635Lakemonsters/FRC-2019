...
public class SwitcherDownCommand extends Command {
  ...
  protected void initialize() {
    SwitcherState prevPosition = Robot.switcher.getPrevPosition();
    if(prevPosition == SwitcherState.HATCH){
      Robot.switcher.moveSwitch(SwitcherState.CARGO);
    }else if(prevPosition == SwitcherState.CARGO){
